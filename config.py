...
DANGEROUS_REPTILES = [
    ...
    },
    {
        ...
        'description': 'Lagarto grande con mordedura muy fuerte. No venenoso pero su mordida puede infectarse fácilmente. Muy territorial. Buena onda',
...
DANGEROUS_INSECTS = [
    ...
    },
    {
        ...
        'description': 'Su picadura es considerada una de las más dolorosas del reino animal. El dolor puede durar hasta 24 horas. El nombre se puso por el popular chiste de Héctor sobre unas ranas',
        'danger_level': 'Alto',
